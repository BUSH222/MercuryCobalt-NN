...
export interface SatelliteFailure {
  ...
  start_s: number;
  end_s: number;
  /** Set on failures generated by "Автоматически отключать спутники в тени" — lets the UI badge them and filter them out on re-run/clear, without a parallel data structure alongside manually added failures. */
